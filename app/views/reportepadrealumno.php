...
<head>
    ...
    <title>Reportes Padres alumnos</title>
</head>
<body>
    <section id="menu">
        <?php
    ...
    <div class="content">
        ...
        <section id="contenido">
            <form class="row gy-2 gx-3 align-items-center mt-3 mb-3">
                ...
                <div class="col-auto d-flex">
                    <label class="col-form-label mx-3" for="autoSizingInput">Padre</label>
    ...
    <script src="<?php echo URL;?>public_html/customjs/reportepadrealumno.js"></script>
</body>
</html>