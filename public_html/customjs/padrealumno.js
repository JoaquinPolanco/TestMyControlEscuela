...
function guardarPadrealumno(event) {
    ...
    API.post(formData,"padresalumno/save").then(
        data=>{
...
function cargarDatos() {
    API.get("padresalumno/getAll").then(
        data=>{
        ...
        (item,index)=>{
            if ((index>=recordIni) && (index<=recordFin)){                    
                html+=`
                    ...
                    <td>${item.fecha}</td>
                    <td>
                        <button type="button" class="btn btn-dark btncolor" onclick="editarPadrealumno(${item.id_padre_alumno})"><i class="bi bi-pencil-square"></i></button>
                        <button type="button" class="btn btn-danger btncolor" onclick="eliminarPadrealumno(${item.id_padre_alumno})"><i class="bi bi-trash"></i></button>
                    </td>
                    </tr>                
                `;
            }
...
function editarPadrealumno(id) {
    ...
    API.get("padresalumno/getOnePadresAlumnos?id="+id).then(
        data=>{
            if (data.success) {
    ...
    Swal.fire({
        ...
        resultado=>{
            ...
            if (resultado.isConfirmed) {
                API.get("padresalumno/deletePadresAlumnos?id="+id).then(
                    data=>{
                        if (data.success) {
                            cancelarPadrealumno();
                            Swal.fire({
