...
function guardarSeccion(event) {
    ...
    API.post(formData, "seccion/save").then(
        data => {
        ...
        (item, index) => {
            if ((index >= recordIni) && (index <= recordFin)) {
                ...
                html += `
                    ...
                    <td>
                        <button type="button" class="btn btn-dark btncolor" onclick="editarSeccion(${item.id_seccion})"><i class="bi bi-pencil-square"></i></button>
                        <button type="button" class="btn btn-danger btncolor" onclick="eliminarSeccion(${item.id_seccion})"><i class="bi bi-trash"></i></button>
                    </td>
                    </tr>
...
function editarSeccion(id) {
    ...
    panelDatos.classList.add("d-none");
    panelForm.classList.remove("d-none");
    API.get("seccion/getOneSeccion?id=" + id).then(
        data => {
            if (data.success) {
    ...
    Swal.fire({
        ...
        resultado => {
            ...
            if (resultado.isConfirmed) {
                API.get("seccion/deleteSeccion?id=" + id).then(
                    data => {
                        if (data.success) {
                            cancelarSeccion();
                            Swal.fire({
